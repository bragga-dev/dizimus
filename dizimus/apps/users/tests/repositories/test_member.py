...
from dizimus.apps.users.repositories.member import create_member_profile, update_member_profile
from dizimus.apps.users.models import Member, User
...
class TestMemberRepository:
    ...
    def test_update_member_profile_partial(self, member_user):
        ...
        updated_member = update_member_profile(member, date_of_birth=date(1995, 3, 20))
